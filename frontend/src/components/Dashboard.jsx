...
const Dashboard = () => {
  ...
  const { userXP, addXP, weeklyGoal, achievements } = useXP()
  ...
  const calculateStreak = () => {
    ...
    const streakCount = Number.parseInt(localStorage.getItem("currentStreak") || "0")

    console.log("[v0] Calculating streak - lastActivity:", lastActivity, "streakCount:", streakCount)
    ...
    console.log("[v0] Hours since activity:", hoursSinceActivity, "Hours until loss:", hoursUntilLoss)
  ...
  const simulateQuizActivity = () => {
    const currentTime = Date.now()
    const currentStreak = Number.parseInt(localStorage.getItem("currentStreak") || "0") + 1
    localStorage.setItem("lastQuizActivity", currentTime.toString())
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [quizzesData, quoteData] = await Promise.all([quizAPI.getAllQuizzes(), quoteAPI.getTodaysQuote()])
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      label: "AR Challenge",
      key: "ar-challenge",
      active: activeView === "ar-challenge",
    },
    {
      icon: Target,
      label: "Progress",
    ...
    <div className="space-y-8">
      ...
      {quizzes.length === 0 ? (
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-12 shadow-2xl text-center">
          ...
          <h4 className="text-2xl font-bold text-white mb-4">No quizzes available</h4>
          <p className="text-blue-200">
            {userRole === "teacher" ? "Create your first quiz to get started!" : "Check back soon for new quizzes!"}
          </p>
        </div>
      ) : (
  ...
  const renderAnalyticsView = () => (
    <div className="space-y-8">
      <h2 className="text-3xl font-bold text-white">Environmental Studies Analytics</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="text-sm">
              <div className="text-white font-medium">Climate Change Basics</div>
              <div className="text-blue-200">Scored 92% • 2 hours ago</div>
            </div>
            <div className="text-sm">
              <div className="text-white font-medium">Renewable Energy Systems</div>
              <div className="text-blue-200">Scored 85% • 1 day ago</div>
            </div>
            <div className="text-sm">
              <div className="text-white font-medium">Biodiversity Conservation</div>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
          <h3 className="text-xl font-bold text-white mb-4">Environmental Achievements</h3>
          <div className="space-y-3">
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
        <h3 className="text-xl font-bold text-white mb-6">Environmental Subject Performance</h3>
  ...
  const renderGamesView = () => (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white/10 backdrop-blur-xl border border-purple-400/30 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 group cursor-pointer">
          <div className="text-center space-y-4">
            <div className="bg-gradient-to-r from-purple-500 to-blue-500 p-4 rounded-2xl mx-auto w-fit">
              <Camera className="h-8 w-8 text-white" />
            </div>
            <h3 className="text-xl font-bold text-white">AR Eco-Challenge</h3>
            <p className="text-blue-200">Scan real-world items with your camera</p>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300"
            >
              Start AR Scan
            </button>
          </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-green-400/30 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 group text-center">
          <img
            src="https://img.icons8.com/emoji/96/deciduous-tree-emoji.png"
            alt="Grow Your Tree Logo"
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-yellow-400/30 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 group text-center">
          <img
            src="https://img.icons8.com/emoji/96/wastebasket-emoji.png"
            alt="Sort the Trash Logo"
            className="mx-auto mb-4 w-20 h-20 rounded-full shadow"
          />
        ...
        {showSortTrashGame && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
            <div className="bg-white rounded-xl shadow-lg p-8 relative w-full max-w-3xl flex flex-col items-center">
              ...
              <iframe
                src="https://scratch.mit.edu/projects/1215200115/embed"
              ...
              <p className="text-yellow-700 text-center">
                Interact with the game to learn how to sort trash correctly!
              </p>
            </div>
          </div>
        )}
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 group cursor-pointer">
          <div className="text-center space-y-4">
            ...
            <p className="text-blue-200">Compete for the top spot on the leaderboard</p>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 group cursor-pointer">
          <div className="text-center space-y-4">
            ...
            <p className="text-blue-200">Test your knowledge against the clock</p>
      ...
      {showGrowTreeGame && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
          <div className="bg-white rounded-xl shadow-lg p-8 relative w-full max-w-3xl flex flex-col items-center">
            ...
            <iframe
              src="https://scratch.mit.edu/projects/1215616271/embed"
              allowtransparency="true"
              width="800"
              height="500"
              frameBorder="0"
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-red-200">
                You're about to lose your {streakData.currentStreak}-day streak! Complete a quiz in the next{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-lg font-bold text-white">Climate Change</span>
            </div>
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                ...
                {streakData.hoursUntilLoss > 0 && streakData.currentStreak > 0 && (
                  <div className="text-xs text-blue-300">{streakData.hoursUntilLoss}h left</div>
                )}
              </div>
            </div>
            <div className="mt-4 p-3 bg-white/5 rounded-xl">
              <p className={`text-sm ${getStreakMessage().color} flex items-center space-x-2`}>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-blue-200">Quizzes completed: 8 (+3)</div>
            <div className="text-sm text-blue-200">Average time: 12 min (-2 min)</div>
          </div>
        </div>
      </div>
      ...
      {userRole === "teacher" && (
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-white">Class Environmental Studies Statistics</h3>
            <Link
              to="/student-progress"
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded-xl p-4">
              <h4 className="text-lg font-semibold text-white mb-2">Climate Change</h4>
              <div className="text-2xl font-bold text-blue-400">82%</div>
              <div className="text-sm text-blue-200">Average Score</div>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h4 className="text-lg font-semibold text-white mb-2">Renewable Energy</h4>
              <div className="text-2xl font-bold text-green-400">89%</div>
              <div className="text-sm text-blue-200">Average Score</div>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h4 className="text-lg font-semibold text-white mb-2">Biodiversity</h4>
  ...
  const renderVideosView = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-bold text-white">Environmental Studies Video Lectures</h2>
        ...
        <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-xl border border-green-400/30 rounded-2xl p-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-2">🌱 Eco-Learning Progress</h3>
              <p className="text-green-200">
                You've completed 3 environmental studies modules this week! Keep learning to protect our planet.
              </p>
            </div>
          </div>
        </div>
    ...
    return (
      <div className="space-y-6">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
          ...
          <p className="text-blue-200">Manage your environmental studies classes and track student progress</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-xl border border-purple-400/30 rounded-2xl p-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-white">Avg Class Score</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-xl">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">Completed Climate Change Quiz</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-xl">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">Completed Renewable Energy Quiz</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-xl">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">Started Biodiversity Quiz</p>
                  </div>
                </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
            <h3 className="text-xl font-bold text-white mb-6">Class Performance Overview</h3>
            <div className="space-y-4">
              <div>
        ...
        <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-xl border border-green-400/30 rounded-2xl p-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-2">🌍 Class Environmental Impact</h3>
              <p className="text-green-200">
                Your students have completed 156 environmental quizzes this month, contributing to a more sustainable
                future!
              </p>
            </div>
          </div>
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <span className="text-2xl font-bold text-violet-300">{userXP}</span>
                </div>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-r from-teal-500/20 to-green-500/20 backdrop-blur-xl border border-teal-400/30 rounded-2xl p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              onClick={() => setShowARChallenge(true)}
              className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center space-x-3"
            >
              <Camera className="h-5 w-5" />
              <span>AR Challenge</span>
            </button>
            ...
            <button
              ...
              className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center space-x-3"
            >
              <BarChart3 className="h-5 w-5" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-xl">
                ...
                <div>
                  <p className="text-white font-medium">Environmental Basics Quiz</p>
                  <p className="text-blue-200 text-sm">Completed • Score: 92%</p>
                </div>
              </div>
              <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-xl">
              ...
              <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-purple-200 text-sm">15% improvement this week</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
            ...
            {todaysQuote ? (
              <div className="space-y-4">
                <blockquote className="text-white italic text-lg leading-relaxed">"{todaysQuote.text}"</blockquote>
                <cite className="text-blue-200 text-sm">— {todaysQuote.author}</cite>
              </div>
            ) : (
              <div className="space-y-4">
    ...
    if (userRole !== "teacher") {
      return (
        <div className="p-6 text-center">
          <p className="text-white/70">Access denied. This section is for teachers only.</p>
        </div>
      )
    }
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-xl p-4 border border-white/20">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-white text-xl font-bold">{Math.max(...students.map((s) => s.streak))}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-white/5">
                <tr>
                  ...
                  <th className="text-left p-4 text-white/70 font-medium">Streak</th>
                  <th className="text-left p-4 text-white/70 font-medium">Progress</th>
              ...
              <tbody>
                {students.map((student) => (
                  <tr key={student.id} className="border-t border-white/10 hover:bg-white/5 transition-colors">
                    <td className="p-4">
                      <div className="flex items-center space-x-3">
                    ...
                    <td className="p-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-white font-medium">{student.streak}</span>
                      </div>
                    </td>
                    <td className="p-4">
                      <div className="flex items-center space-x-2">
          ...
          <div className="bg-white/60 backdrop-blur-xl border border-indigo-200/50 rounded-3xl p-8 shadow-2xl">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                <h3 className="text-xl font-semibold text-indigo-900 mb-2">Loading your dashboard...</h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
            ...
            {sidebarItems.map((item) => (
              ...
              >
                {React.createElement(item.icon, {
                  className: `h-5 w-5 ${item.active ? "text-white" : "group-hover:text-white"} transition-colors`,
                })}
            ...
            <div className="flex items-center space-x-3 p-3 rounded-xl bg-white/10">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white font-medium truncate">
                  {user?.name || (userRole === "teacher" ? "Teacher" : "Student")}
                </p>
      ...
      <div className="lg:ml-64">
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center space-x-4">
                ...
                <h1 className="text-xl font-bold text-white capitalize">{activeView}</h1>
              </div>
        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-8">{renderActiveView()}</div>
      </div>
